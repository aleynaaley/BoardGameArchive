...
CREATE TABLE tblUye(
	UYE_ID INT PRIMARY KEY NOT NULL,
	AD_Üye VARCHAR(50),
...
create table tblRozet(
	ROZET_ID INT PRIMARY KEY NOT NULL,
	ROZET_AD varchar(50)
)
...
create table tblYayin(
	YAYIN_ID INT PRIMARY KEY NOT NULL,
...
CREATE TABLE tblOyuna_puan_verir(
 ID INT IDENTITY(1,1) PRIMARY KEY,
 KOLEKSIYON INT FOREIGN KEY REFERENCES tblYayin(YAYIN_ID) NOT NULL,
 OYUN INT FOREIGN KEY REFERENCES tblYayin(YAYIN_ID) NOT NULL,
)
...
-- OYUN VE MEKAN�KLER �L��K� TABLOSU
...
-- TASARIMCI VE G�REV ALANI TABLOSU
