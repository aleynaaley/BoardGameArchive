...
/* Bu trigger, tblKoleksiyon tablosuna yapılan INSERT veya DELETE işlemleri sonrasında:
  Kullanıcının toplam oyun sayısını hesaplar.Eğer oyun sayısı 15'i aşarsa, işlem iptal edilir.Toplam oyun sayısına göre kullanıcının rozetini günceller (Amatör, Usta, Efsane Koleksiyoncu).
  Kullanıcı profilini günceller veya yeni bir profil kaydı ekler.Hata durumunda işlemi geri alır ve hata mesajı döner.*/
